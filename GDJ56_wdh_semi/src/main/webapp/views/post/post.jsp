...
<div id="write-container">
    <form action="<%=request.getContextPath() %>/views/post/finish.jsp" method="post">
		<div class="wrap" style="margin-top: 3%;">
			...
			<script>
				const goPopup=()=>{
					var pop=window.open("<%=request.getContextPath()%>/post/map.do","pop","width=700,height=550, scrollbars=yes, resizable=yes");
				}
